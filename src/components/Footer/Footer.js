        ...
        <footer className="p-5 mt-5">
            <div className="row">
                <div className="col-md-3 mt-3">
                    <h5>Useful Links</h5>
                    <Link className="link" to="#">About Us</Link><br />
                ...
                <div className="col-md-6 mt-3">
                    ...
                    <p>1202 South Badda, Dhaka, Bangladesh </p>
                ...
                <div className="col-md-3 mt-3">
                    ...
                    <img src="https://true-traveller.web.app/static/media/payment.77dd86ea.png" style={{ width: '190px' }} alt="" />
                </div>

                <div className="mx-auto mt-5">
                    <p>Copyright &copy;{(new Date()).getFullYear()} by SHOPKORI | All Rights Reserved</p>
                </div>
            </div>
        </footer >
    );
